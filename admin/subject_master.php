...
mysqli_query($con,"UPDATE `subjects` set status='1' where id='$uid'");
  }else{
    mysqli_query($con,"UPDATE `subjects` set status='0' where id='$uid'");
  }
}
if($type=='delete'){
mysqli_query($con,"delete from `subjects` where `subjects`.`id`='$uid'");
}
}
...
<div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <p><a style="color:#ffffff;" href="manage_subjects.php">Add Subjects here </a></p>
        </div>
      </div>
    </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        ...
                        <span class="status"><?php echo $row['sub'] ?></span>
                      </span>
                    </td>
                    <td>
                      <span class="badge badge-dot mr-4">
                        <i class="bg-warning"></i>
                        <span class="status"><?php echo $row['class'] ?></span>
                      </span>
                    </td>
                    <td class="text-right">
                    <p><?php
                    ...
                    ?></p>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <a class="dropdown-item" href="manage_subjects.php?id=<?php echo $row['id'] ?>">edit</a>

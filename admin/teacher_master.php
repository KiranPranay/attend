...
mysqli_query($con,"UPDATE `teachers` set status='1' where id='$uid'");
  }else{
    mysqli_query($con,"UPDATE `teachers` set status='0' where id='$uid'");
  }
}
if($type=='delete'){
mysqli_query($con,"delete from `teachers` where `teachers`.`id`='$uid'");
}
}
...
<div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <p><a style="color:#ffffff;" href="manage_teachers.php">Add teachers here </a></p>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                <?php
$res=mysqli_query($con,"SELECT * FROM `teachers`");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        <i class="bg-warning"></i>
                        <span class="status"><?php echo $row['mobile'] ?></span>
                      </span>
                    </td>
                    <td>
                      <div class="d-flex align-items-center">
                        <span class="completion mr-2"><?php echo $row['password'] ?></span>
                        <div>
                    ...
                    ?></p>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <a class="dropdown-item" href="manage_teachers.php?id=<?php echo $row['id'] ?>">edit</a>

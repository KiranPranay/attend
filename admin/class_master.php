...
mysqli_query($con,"UPDATE `classes` set status='1' where id='$uid'");
  }else{
    mysqli_query($con,"UPDATE `classes` set status='0' where id='$uid'");
  }
}
if($type=='delete'){
mysqli_query($con,"delete from `classes` where `classes`.`id`='$uid'");
}
}
...
<div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <p><a style="color:#ffffff;" href="manage_classes.php">Add Classes here </a></p>
        </div>
      </div>
    </div>
                    ...
                    ?></p>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <a class="dropdown-item" href="manage_classes.php?id=<?php echo $row['id'] ?>">edit</a>

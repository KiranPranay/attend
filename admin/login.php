...
$res="SELECT * from `admin-users` where `admin-users`.`name`='$name' and `admin-users`.`password`='$password'";
$result = $con->query($res);
$row=mysqli_fetch_assoc(mysqli_query($con,$res));
$count=mysqli_num_rows($result);
if($count>0){
  $status='yes';
    $_SESSION['ADMIN_LOGIN']=$status;
          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST" action="login.php">
                ...
                <span class="text-lead" style="color:red;"><?php echo $error ?></span>

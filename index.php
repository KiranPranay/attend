...
<p><bold>Name : </bold><?php echo $row['name'] ?></p> 
<p>email : <?php echo $row['email'] ?></p>
<p>mobile : <?php echo $row['mobile'] ?></p>
<a href="logout.php" class="btn btn-success btn-submit"><i class="fas fa-sign-out-alt"></i> logout here</a>
            </div>
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Select Your Class</small>
              </div>
              <form role="form" method="POST" action="attendance_sheet.php">
